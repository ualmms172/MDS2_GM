...
<vaadin-horizontal-layout class="content" style="width: 100%; height: 100%;position:absolute" id="vaadinHorizontalLayout">
 <vaadin-vertical-layout theme="spacing" style="flex-grow: 1; width: 25%;" id="verticalLayout-izquierda">
 ...
 <vaadin-vertical-layout theme="spacing" style="flex-grow: 1; width: 25%;" id="verticalLayout-derecha">
  <vaadin-horizontal-layout theme="spacing" style="flex-grow: 1; width: 100%;" id="horizontalLayout-ListaHashtags">
