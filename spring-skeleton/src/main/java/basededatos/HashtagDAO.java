...
public class HashtagDAO {
	public static Hashtag loadHashtagByORMID(int id_hash) throws PersistentException {
		try {
			PersistentSession session = MDS12425PFGallardoMartínezPersistentManager.instance().getSession();
			return loadHashtagByORMID(session, id_hash);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Hashtag getHashtagByORMID(int id_hash) throws PersistentException {
		try {
			PersistentSession session = MDS12425PFGallardoMartínezPersistentManager.instance().getSession();
			return getHashtagByORMID(session, id_hash);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Hashtag loadHashtagByORMID(int id_hash, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = MDS12425PFGallardoMartínezPersistentManager.instance().getSession();
			return loadHashtagByORMID(session, id_hash, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Hashtag getHashtagByORMID(int id_hash, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = MDS12425PFGallardoMartínezPersistentManager.instance().getSession();
			return getHashtagByORMID(session, id_hash, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Hashtag loadHashtagByORMID(PersistentSession session, int id_hash) throws PersistentException {
		try {
			return (Hashtag) session.load(basededatos.Hashtag.class, Integer.valueOf(id_hash));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Hashtag getHashtagByORMID(PersistentSession session, int id_hash) throws PersistentException {
		try {
			return (Hashtag) session.get(basededatos.Hashtag.class, Integer.valueOf(id_hash));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Hashtag loadHashtagByORMID(PersistentSession session, int id_hash, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Hashtag) session.load(basededatos.Hashtag.class, Integer.valueOf(id_hash), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Hashtag getHashtagByORMID(PersistentSession session, int id_hash, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Hashtag) session.get(basededatos.Hashtag.class, Integer.valueOf(id_hash), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(basededatos.Hashtag hashtag) throws PersistentException {
		try {
			MDS12425PFGallardoMartínezPersistentManager.instance().saveObject(hashtag);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(basededatos.Hashtag hashtag) throws PersistentException {
		try {
			MDS12425PFGallardoMartínezPersistentManager.instance().deleteObject(hashtag);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(basededatos.Hashtag hashtag)throws PersistentException {
		try {
			if (hashtag.getCreadoPor() != null) {
				hashtag.getCreadoPor().creaHashtag.remove(hashtag);
			}
	...
	public static boolean refresh(basededatos.Hashtag hashtag) throws PersistentException {
		try {
			MDS12425PFGallardoMartínezPersistentManager.instance().getSession().refresh(hashtag);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(basededatos.Hashtag hashtag) throws PersistentException {
		try {
			MDS12425PFGallardoMartínezPersistentManager.instance().getSession().evict(hashtag);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
