...
public class MDS12425PFGallardoMartínezPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MDS12425PFGallardoMartínez";
	...
	private MDS12425PFGallardoMartínezPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(basededatos.Logueado.class);
		aMetadataSources.addAnnotatedClass(basededatos.UsuarioRegistrado.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MDS12425PFGallardoMartínezPersistentManager();
		}
