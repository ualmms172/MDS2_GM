...
@Tag("vista-usuariosbaneados")
@JsModule("./views/vista-usuariosbaneados.ts")
public class VistaUsuariosbaneados extends LitTemplate {
	...
	public Element getVerticalListausuariosbaneados() {
		return verticalListausuariosbaneados;
	}
